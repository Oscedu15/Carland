...
//HOURS
const hours = ["10:00 AM", "12:00 MD", "14:00 AM", "16:00 PM"];
  ...
  return (
    <Menu as="div" className="w-full h-full flex xl:flex-row">
      <div className="relative flex-1">
        ...
        {/* Items */}
        <Menu.Items
          className="drodown-menu shadow-lg absolute -top-72
        xl:top-[80px] left-1/2 xl:left-0 z-10 transform -translate-x-1/2 xl:-translate-x-0
        text-sm w-full bg-white max-w-[332px] py-6 rounded-[10px]"
        >{hours?.map((hour, index) => {
          return <div key={index} onClick={() => setHour(hour)}
