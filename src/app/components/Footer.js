        ...
        <motion.div variants={fadeIn('up', 0.2)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.2}}
         className="flex flex-col lg:flex-row lg:justify-between gap-x-5 gap-y-14">
          ...
          <div className="flex-1">
            ...
            <div className="mb-9 text-secondary">Lorem ipsum dolor sit amet consectetur adipsicing elit.</div>
            {/* form */}
            <form className="flex gap-x-2 h-14">
              <input className="outline-none bg-white h-full border rounded-lg pl-4 focus:border-accent"
